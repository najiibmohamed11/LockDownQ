...
export function QuestionsList({ questions, onAddQuestion }: QuestionsListProps) {
  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-4">
        ...
        <Button className="bg-purple-600 hover:bg-purple-700" onClick={onAddQuestion}>
                        ...
                        {question.options?.map((option: any, optIndex: number) => (
                          <div key={optIndex} className="flex items-center">
                            ...
                            <span
                              className={cn(
                                "text-purple-800",
                                JSON.stringify(option) === JSON.stringify(question.answer) && "text-green-800 font-medium"
                              )}
                            >
